...
\
	...
	document.getElementById('failure').innerHTML = '<div class="alert alert-info"><button type="button" class="close" data-dismiss="alert">&times;</button>authentication commencing</div>';
