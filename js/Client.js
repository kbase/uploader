(function () {
    ...
    Workspace.init = function(url, auth, auth_cb) {
    ...
    Workspace.create_workspace = function (params, _callback, _errorCallback) {
    return json_call_ajax("Workspace.create_workspace",
        [params], 1, _callback, _errorCallback);
};

    Workspace.create_workspace_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.create_workspace", [params], 1, _callback, _error_callback);
    };

    Workspace.clone_workspace = function (params, _callback, _errorCallback) {
    return json_call_ajax("Workspace.clone_workspace",
        [params], 1, _callback, _errorCallback);
};

    Workspace.clone_workspace_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.clone_workspace", [params], 1, _callback, _error_callback);
    };

    Workspace.lock_workspace = function (wsi, _callback, _errorCallback) {
    return json_call_ajax("Workspace.lock_workspace",
        [wsi], 1, _callback, _errorCallback);
};

    Workspace.lock_workspace_async = function (wsi, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.lock_workspace", [wsi], 1, _callback, _error_callback);
    };

    Workspace.get_workspacemeta = function (params, _callback, _errorCallback) {
    return json_call_ajax("Workspace.get_workspacemeta",
        [params], 1, _callback, _errorCallback);
};

    Workspace.get_workspacemeta_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.get_workspacemeta", [params], 1, _callback, _error_callback);
    };

    Workspace.get_workspace_info = function (wsi, _callback, _errorCallback) {
    return json_call_ajax("Workspace.get_workspace_info",
        [wsi], 1, _callback, _errorCallback);
};

    Workspace.get_workspace_info_async = function (wsi, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.get_workspace_info", [wsi], 1, _callback, _error_callback);
    };

    Workspace.get_workspace_description = function (wsi, _callback, _errorCallback) {
    return json_call_ajax("Workspace.get_workspace_description",
        [wsi], 1, _callback, _errorCallback);
};

    Workspace.get_workspace_description_async = function (wsi, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.get_workspace_description", [wsi], 1, _callback, _error_callback);
    };

    Workspace.set_permissions = function (params, _callback, _errorCallback) {
    return json_call_ajax("Workspace.set_permissions",
        [params], 0, _callback, _errorCallback);
};

    Workspace.set_permissions_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.set_permissions", [params], 0, _callback, _error_callback);
    };

    Workspace.set_global_permission = function (params, _callback, _errorCallback) {
    return json_call_ajax("Workspace.set_global_permission",
        [params], 0, _callback, _errorCallback);
};

    Workspace.set_global_permission_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.set_global_permission", [params], 0, _callback, _error_callback);
    };

    Workspace.set_workspace_description = function (params, _callback, _errorCallback) {
    return json_call_ajax("Workspace.set_workspace_description",
        [params], 0, _callback, _errorCallback);
};

    Workspace.set_workspace_description_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.set_workspace_description", [params], 0, _callback, _error_callback);
    };

    Workspace.get_permissions = function (wsi, _callback, _errorCallback) {
    return json_call_ajax("Workspace.get_permissions",
        [wsi], 1, _callback, _errorCallback);
};

    Workspace.get_permissions_async = function (wsi, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.get_permissions", [wsi], 1, _callback, _error_callback);
    };

    Workspace.save_object = function (params, _callback, _errorCallback) {
    return json_call_ajax("Workspace.save_object",
        [params], 1, _callback, _errorCallback);
};

    Workspace.save_object_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.save_object", [params], 1, _callback, _error_callback);
    };

    Workspace.save_objects = function (params, _callback, _errorCallback) {
    return json_call_ajax("Workspace.save_objects",
        [params], 1, _callback, _errorCallback);
};

    Workspace.save_objects_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.save_objects", [params], 1, _callback, _error_callback);
    };

    Workspace.get_object = function (params, _callback, _errorCallback) {
    return json_call_ajax("Workspace.get_object",
        [params], 1, _callback, _errorCallback);
};

    Workspace.get_object_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.get_object", [params], 1, _callback, _error_callback);
    };

    Workspace.get_objects = function (object_ids, _callback, _errorCallback) {
    return json_call_ajax("Workspace.get_objects",
        [object_ids], 1, _callback, _errorCallback);
};

    Workspace.get_objects_async = function (object_ids, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.get_objects", [object_ids], 1, _callback, _error_callback);
    };

    Workspace.get_object_subset = function (sub_object_ids, _callback, _errorCallback) {
    return json_call_ajax("Workspace.get_object_subset",
        [sub_object_ids], 1, _callback, _errorCallback);
};

    Workspace.get_object_subset_async = function (sub_object_ids, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.get_object_subset", [sub_object_ids], 1, _callback, _error_callback);
    };

    Workspace.get_object_history = function (object, _callback, _errorCallback) {
    return json_call_ajax("Workspace.get_object_history",
        [object], 1, _callback, _errorCallback);
};

    Workspace.get_object_history_async = function (object, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.get_object_history", [object], 1, _callback, _error_callback);
    };

    Workspace.list_referencing_objects = function (object_ids, _callback, _errorCallback) {
    return json_call_ajax("Workspace.list_referencing_objects",
        [object_ids], 1, _callback, _errorCallback);
};

    Workspace.list_referencing_objects_async = function (object_ids, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.list_referencing_objects", [object_ids], 1, _callback, _error_callback);
    };

    Workspace.list_workspaces = function (params, _callback, _errorCallback) {
    return json_call_ajax("Workspace.list_workspaces",
        [params], 1, _callback, _errorCallback);
};

    Workspace.list_workspaces_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.list_workspaces", [params], 1, _callback, _error_callback);
    };

    Workspace.list_workspace_info = function (params, _callback, _errorCallback) {
    return json_call_ajax("Workspace.list_workspace_info",
        [params], 1, _callback, _errorCallback);
};

    Workspace.list_workspace_info_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.list_workspace_info", [params], 1, _callback, _error_callback);
    };

    Workspace.list_workspace_objects = function (params, _callback, _errorCallback) {
    return json_call_ajax("Workspace.list_workspace_objects",
        [params], 1, _callback, _errorCallback);
};

    Workspace.list_workspace_objects_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.list_workspace_objects", [params], 1, _callback, _error_callback);
    };

    Workspace.list_objects = function (params, _callback, _errorCallback) {
    return json_call_ajax("Workspace.list_objects",
        [params], 1, _callback, _errorCallback);
};

    Workspace.list_objects_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.list_objects", [params], 1, _callback, _error_callback);
    };

    Workspace.get_objectmeta = function (params, _callback, _errorCallback) {
    return json_call_ajax("Workspace.get_objectmeta",
        [params], 1, _callback, _errorCallback);
};

    Workspace.get_objectmeta_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.get_objectmeta", [params], 1, _callback, _error_callback);
    };

    Workspace.get_object_info = function (object_ids, includeMetadata, _callback, _errorCallback) {
    return json_call_ajax("Workspace.get_object_info",
        [object_ids, includeMetadata], 1, _callback, _errorCallback);
};

    Workspace.get_object_info_async = function (object_ids, includeMetadata, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.get_object_info", [object_ids, includeMetadata], 1, _callback, _error_callback);
    };

    Workspace.rename_workspace = function (params, _callback, _errorCallback) {
    return json_call_ajax("Workspace.rename_workspace",
        [params], 1, _callback, _errorCallback);
};

    Workspace.rename_workspace_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.rename_workspace", [params], 1, _callback, _error_callback);
    };

    Workspace.rename_object = function (params, _callback, _errorCallback) {
    return json_call_ajax("Workspace.rename_object",
        [params], 1, _callback, _errorCallback);
};

    Workspace.rename_object_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.rename_object", [params], 1, _callback, _error_callback);
    };

    Workspace.copy_object = function (params, _callback, _errorCallback) {
    return json_call_ajax("Workspace.copy_object",
        [params], 1, _callback, _errorCallback);
};

    Workspace.copy_object_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.copy_object", [params], 1, _callback, _error_callback);
    };

    Workspace.revert_object = function (object, _callback, _errorCallback) {
    return json_call_ajax("Workspace.revert_object",
        [object], 1, _callback, _errorCallback);
};

    Workspace.revert_object_async = function (object, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.revert_object", [object], 1, _callback, _error_callback);
    };

    Workspace.hide_objects = function (object_ids, _callback, _errorCallback) {
    return json_call_ajax("Workspace.hide_objects",
        [object_ids], 0, _callback, _errorCallback);
};

    Workspace.hide_objects_async = function (object_ids, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.hide_objects", [object_ids], 0, _callback, _error_callback);
    };

    Workspace.unhide_objects = function (object_ids, _callback, _errorCallback) {
    return json_call_ajax("Workspace.unhide_objects",
        [object_ids], 0, _callback, _errorCallback);
};

    Workspace.unhide_objects_async = function (object_ids, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.unhide_objects", [object_ids], 0, _callback, _error_callback);
    };

    Workspace.delete_objects = function (object_ids, _callback, _errorCallback) {
    return json_call_ajax("Workspace.delete_objects",
        [object_ids], 0, _callback, _errorCallback);
};

    Workspace.delete_objects_async = function (object_ids, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.delete_objects", [object_ids], 0, _callback, _error_callback);
    };

    Workspace.undelete_objects = function (object_ids, _callback, _errorCallback) {
    return json_call_ajax("Workspace.undelete_objects",
        [object_ids], 0, _callback, _errorCallback);
};

    Workspace.undelete_objects_async = function (object_ids, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.undelete_objects", [object_ids], 0, _callback, _error_callback);
    };

    Workspace.delete_workspace = function (wsi, _callback, _errorCallback) {
    return json_call_ajax("Workspace.delete_workspace",
        [wsi], 0, _callback, _errorCallback);
};

    Workspace.delete_workspace_async = function (wsi, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.delete_workspace", [wsi], 0, _callback, _error_callback);
    };

    Workspace.undelete_workspace = function (wsi, _callback, _errorCallback) {
    return json_call_ajax("Workspace.undelete_workspace",
        [wsi], 0, _callback, _errorCallback);
};

    Workspace.undelete_workspace_async = function (wsi, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.undelete_workspace", [wsi], 0, _callback, _error_callback);
    };

    Workspace.request_module_ownership = function (mod, _callback, _errorCallback) {
    return json_call_ajax("Workspace.request_module_ownership",
        [mod], 0, _callback, _errorCallback);
};

    Workspace.request_module_ownership_async = function (mod, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.request_module_ownership", [mod], 0, _callback, _error_callback);
    };

    Workspace.register_typespec = function (params, _callback, _errorCallback) {
    return json_call_ajax("Workspace.register_typespec",
        [params], 1, _callback, _errorCallback);
};

    Workspace.register_typespec_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.register_typespec", [params], 1, _callback, _error_callback);
    };

    Workspace.register_typespec_copy = function (params, _callback, _errorCallback) {
    return json_call_ajax("Workspace.register_typespec_copy",
        [params], 1, _callback, _errorCallback);
};

    Workspace.register_typespec_copy_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.register_typespec_copy", [params], 1, _callback, _error_callback);
    };

    Workspace.release_module = function (mod, _callback, _errorCallback) {
    return json_call_ajax("Workspace.release_module",
        [mod], 1, _callback, _errorCallback);
};

    Workspace.release_module_async = function (mod, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.release_module", [mod], 1, _callback, _error_callback);
    };

    Workspace.list_modules = function (params, _callback, _errorCallback) {
    return json_call_ajax("Workspace.list_modules",
        [params], 1, _callback, _errorCallback);
};

    Workspace.list_modules_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.list_modules", [params], 1, _callback, _error_callback);
    };

    Workspace.list_module_versions = function (params, _callback, _errorCallback) {
    return json_call_ajax("Workspace.list_module_versions",
        [params], 1, _callback, _errorCallback);
};

    Workspace.list_module_versions_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.list_module_versions", [params], 1, _callback, _error_callback);
    };

    Workspace.get_module_info = function (params, _callback, _errorCallback) {
    return json_call_ajax("Workspace.get_module_info",
        [params], 1, _callback, _errorCallback);
};

    Workspace.get_module_info_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.get_module_info", [params], 1, _callback, _error_callback);
    };

    Workspace.get_jsonschema = function (type, _callback, _errorCallback) {
    return json_call_ajax("Workspace.get_jsonschema",
        [type], 1, _callback, _errorCallback);
};

    Workspace.get_jsonschema_async = function (type, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.get_jsonschema", [type], 1, _callback, _error_callback);
    };

    Workspace.translate_from_MD5_types = function (md5_types, _callback, _errorCallback) {
    return json_call_ajax("Workspace.translate_from_MD5_types",
        [md5_types], 1, _callback, _errorCallback);
};

    Workspace.translate_from_MD5_types_async = function (md5_types, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.translate_from_MD5_types", [md5_types], 1, _callback, _error_callback);
    };

    Workspace.translate_to_MD5_types = function (sem_types, _callback, _errorCallback) {
    return json_call_ajax("Workspace.translate_to_MD5_types",
        [sem_types], 1, _callback, _errorCallback);
};

    Workspace.translate_to_MD5_types_async = function (sem_types, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.translate_to_MD5_types", [sem_types], 1, _callback, _error_callback);
    };

    Workspace.get_type_info = function (type, _callback, _errorCallback) {
    return json_call_ajax("Workspace.get_type_info",
        [type], 1, _callback, _errorCallback);
};

    Workspace.get_type_info_async = function (type, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.get_type_info", [type], 1, _callback, _error_callback);
    };

    Workspace.get_func_info = function (func, _callback, _errorCallback) {
    return json_call_ajax("Workspace.get_func_info",
        [func], 1, _callback, _errorCallback);
};

    Workspace.get_func_info_async = function (func, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.get_func_info", [func], 1, _callback, _error_callback);
    };

    Workspace.grant_module_ownership = function (params, _callback, _errorCallback) {
    return json_call_ajax("Workspace.grant_module_ownership",
        [params], 0, _callback, _errorCallback);
};

    Workspace.grant_module_ownership_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.grant_module_ownership", [params], 0, _callback, _error_callback);
    };

    Workspace.remove_module_ownership = function (params, _callback, _errorCallback) {
    return json_call_ajax("Workspace.remove_module_ownership",
        [params], 0, _callback, _errorCallback);
};

    Workspace.remove_module_ownership_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.remove_module_ownership", [params], 0, _callback, _error_callback);
    };

    Workspace.administer = function (command, _callback, _errorCallback) {
    return json_call_ajax("Workspace.administer",
        [command], 1, _callback, _errorCallback);
};

    Workspace.administer_async = function (command, _callback, _error_callback) {
        deprecationWarning();
    ...
    function json_call_ajax(method, params, numRets, callback, errorCallback) {
        ...
        var beforeSend = null;
        var token = (Workspace.auth_cb && typeof Workspace.auth_cb === 'function') ? Workspace.auth_cb() : (Workspace.auth && Workspace.auth.token ? Workspace.auth.token : null);
        if (token != null) {
